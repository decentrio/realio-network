...
import (
	...
	chainutil "github.com/realiotech/realio-network/example_chain/testutil"
	commonnetwork "github.com/evmos/os/testutil/integration/common/network"
	"github.com/evmos/os/types"
	erc20types "github.com/evmos/os/x/erc20/types"
	evmtypes "github.com/evmos/os/x/evm/types"
	feemarkettypes "github.com/evmos/os/x/feemarket/types"
	app "github.com/realiotech/realio-network/example_chain"
)
...
func (n *IntegrationNetwork) configureAndInitChain() error {
	...
	fmt.Println("genesisState", genesisState["asset"])
