...
replace (
	...
	github.com/evmos/os => github.com/evmos/os v0.0.0-20250108125741-e95afb000453
...
// github.com/realiotech/realio-network/x/asset => ../realio-network-decentrio/x/asset
)
