...
func NewExampleApp(
	...
	*/
	...
	app.ModuleManager = module.NewManager(
		...
		asset.NewAppModule(appCodec, app.AssetKeeper, app.BankKeeper, app.GetSubspace(assettypes.ModuleName)),
	)
...
func (a *ExampleChain) DefaultGenesis() map[string]json.RawMessage {
	...
	assetGenState := NewAssetGenesisState()
	genesis[assettypes.ModuleName] = a.appCodec.MustMarshalJSON(assetGenState)
