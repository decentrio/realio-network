...
type MsgCreateToken struct {
	...
	Managers           [][]byte              `protobuf:"bytes,6,rep,name=managers,proto3" json:"managers,omitempty"`
...
func (m *MsgCreateToken) GetIssuer() []byte {
	if m != nil {
		return m.Issuer
	}
	return nil
...
func (m *MsgCreateToken) GetManagers() [][]byte {
	if m != nil {
		return m.Managers
	}
	return nil
...
type MsgAssignRoles struct {
	...
	Managers [][]byte `protobuf:"bytes,3,rep,name=managers,proto3" json:"managers,omitempty"`
}
...
func (m *MsgAssignRoles) GetIssuer() []byte {
	if m != nil {
		return m.Issuer
	}
	return nil
...
func (m *MsgAssignRoles) GetManagers() [][]byte {
	if m != nil {
		return m.Managers
	}
	return nil
...
type MsgUnassignRoles struct {
	...
	Issuer   []byte `protobuf:"bytes,1,opt,name=issuer,proto3" json:"issuer,omitempty"`
	TokenId  string `protobuf:"bytes,2,opt,name=token_id,json=tokenId,proto3" json:"token_id,omitempty"`
	Managers []byte `protobuf:"bytes,3,opt,name=managers,proto3" json:"managers,omitempty"`
}
...
func (m *MsgUnassignRoles) GetIssuer() []byte {
	if m != nil {
		return m.Issuer
	}
	return nil
...
func (m *MsgUnassignRoles) GetManagers() []byte {
	if m != nil {
		return m.Managers
	}
	return nil
...
var fileDescriptor_1cfda60866e68e13 = []byte{
	...
	,
}
...
func (m *MsgCreateToken) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Managers = append(m.Managers, make([]byte, postIndex-iNdEx))
			copy(m.Managers[len(m.Managers)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 8:
			if wireType != 0 {
...
func (m *MsgUnassignRoles) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Managers = append(m.Managers[:0], dAtA[iNdEx:postIndex]...)
			if m.Managers == nil {
				m.Managers = []byte{}
			}
			iNdEx = postIndex
